...
public class CalculatorTest {
    public static void main(String[] args) {
        ...
        assertThat(Calculator.calculatingDiscount(200, 10)).isEqualTo(180.0);
        assertThat(Calculator.calculatingDiscount(50, 0)).isEqualTo(50.0); // Без скидки

        // Проверка на выбрасывание исключения при недопустимых аргументах
        assertThatThrownBy(() ->
